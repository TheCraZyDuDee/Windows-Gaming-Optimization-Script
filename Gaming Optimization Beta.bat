...
echo 15. Killing Floor 2 (Epic Games)
echo 16. Back 4 Blood Beta (Steam)
...
start cmd.exe /c "start "" "com.epicgames.launcher://apps/0584d2013f0149a791e7b9bad0eec102%3A6e563a2c0f5f46e3b4e88b5f4ed50cca%3A9d2d0eb64d5c44529cece33fe2a46482?action=launch&silent=true""
...
start cmd.exe /c "start "" "com.epicgames.launcher://apps/affc33b82405457595a032f00284abd2%3Ab51279fe75d841dd9a0dcb1a1b85bf4b%3AFinch?action=launch&silent=true""
@ping -n 5 localhost> nul
echo Killing Floor 2 started Sucessfully!
goto set_priority_killingfloor2
...
@ping -n 5 localhost> nul
echo Killing Floor 2 started Sucessfully!
goto set_priority_killingfloor2_2
...
if "%c%"=="14" goto impact
if "%c%"=="15" goto killingfloor2
if "%c%"=="16" goto set_priority_b4b
if "%c%"=="17" goto cemu
...
if "%c%"=="14" goto impact
if "%c%"=="15" goto killingfloor2_2
if "%c%"=="16" goto set_priority_b4b_2
if "%c%"=="17" goto cemu_2
...
echo 3 = Start OBS
echo 4 = Start Lightcord
echo 5 = Start Firefox
echo 6 = Start Explorer++
echo 7 = Start Taskmanager
echo 8 = Start Soundmixer
echo 9 = Start Nvidia Control Panel
echo 10 = Exit
echo.
goto select_33
...
echo.
if "%c%"=="6969" goto why...
if "%c%" GTR "10" goto select_33
if "%c%" LSS "1" goto select_33
if "%c%"=="1" goto reset
if "%c%"=="2" goto choose_game_2
if "%c%"=="3" goto obs
if "%c%"=="4" goto start_discord
if "%c%"=="5" goto browser_firefox
if "%c%"=="6" goto explorer
if "%c%"=="7" goto taskmanager
if "%c%"=="8" goto soundmixer
if "%c%"=="9" goto nvidia
if "%c%"=="10" goto exit
...
start "" "C:\Program Files\WindowsApps\NVIDIACorp.NVIDIAControlPanel_8.1.961.0_x64__56jybvy8sckqj\nvcplui.exe"
cls
echo.
