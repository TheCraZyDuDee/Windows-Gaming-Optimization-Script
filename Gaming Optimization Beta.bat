...
start "" "C:\Program Files (x86)\Epic Games\shortcuts\Grand Theft Auto V.lnk"
...
start "" "C:\Program Files (x86)\Epic Games\shortcuts\Killing Floor 2.lnk"
@ping -n 5 localhost> nul
...
echo.
if "%c%"=="6969" goto why...
if "%c%" GTR "6" goto priority_select_outlast_2
if "%c%" LSS "1" goto priority_select_outlast_2
...
echo.
if "%c%"=="6969" goto why...
if "%c%" GTR "6" goto priority_select_outlast_2_2
if "%c%" LSS "1" goto priority_select_outlast_2_2
