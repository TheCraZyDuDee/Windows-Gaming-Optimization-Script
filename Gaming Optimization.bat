...
:wait_splitgate
tasklist|find "PortalWars-Win64-Shipping.exe" >nul
...
:splitgate_p_rt
wmic process where name="PortalWars-Win64-Shipping.exe.exe" CALL setpriority "256" >nul
goto priority_done

:splitgate_p_high
wmic process where name="PortalWars-Win64-Shipping.exe.exe" CALL setpriority "128" >nul
goto priority_done

:splitgate_p_anormal
wmic process where name="PortalWars-Win64-Shipping.exe.exe" CALL setpriority "32768" >nul
goto priority_done

:splitgate_p_normal
wmic process where name="PortalWars-Win64-Shipping.exe.exe" CALL setpriority "32" >nul
goto priority_done

:splitgate_p_bnormal
wmic process where name="PortalWars-Win64-Shipping.exe.exe" CALL setpriority "16384" >nul
goto priority_done

:splitgate_p_low
wmic process where name="PortalWars-Win64-Shipping.exe.exe" CALL setpriority "64" >nul
goto priority_done
