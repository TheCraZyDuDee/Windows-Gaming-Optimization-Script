...
if "%c%"=="11" goto pcbs
if "%c%"=="12" goto impact
if "%c%"=="13" goto splitgate
if "%c%"=="14" goto cemu
if "%c%" GTR "14" goto game_select
...
echo 5  = set_priority_gtasa
echo 6  = set_priority_gtasa_2
echo 7  = set_priority_pcbs
echo 8  = set_priority_pcbs_2
echo 9  = set_priority_raft
echo 10 = set_priority_raft_2
echo 11 = set_priority_genshinimpact
echo 12 = set_priority_genshinimpact_2
echo 13 = set_priority_killingfloor2
echo 14 = set_priority_killingfloor2_2
echo 15 = set_priority_fable
echo 16 = set_priority_fable_2
echo 17 = set_priority_splitgate
echo 18 = set_priority_splitgate_2
echo 19 = set_priority_cemu
echo 20 = set_priority_cemu_2
...
if "%c%"=="5" goto set_priority_gtasa
if "%c%"=="6" goto set_priority_gtasa_2
if "%c%"=="7" goto set_priority_pcbs
if "%c%"=="8" goto set_priority_pcbs_2
if "%c%"=="9" goto set_priority_raft
if "%c%"=="10" goto set_priority_raft_2
if "%c%"=="11" goto set_priority_genshinimpact
if "%c%"=="12" goto set_priority_genshinimpact_2
if "%c%"=="13" goto set_priority_killingfloor2
if "%c%"=="14" goto set_priority_killingfloor2_2
if "%c%"=="15" goto set_priority_fable
if "%c%"=="16" goto set_priority_fable_2
if "%c%"=="17" goto set_priority_splitgate
if "%c%"=="18" goto set_priority_splitgate_2
if "%c%"=="19" goto set_priority_cemu
if "%c%"=="20" goto set_priority_cemu_2
if "%c%" GTR "20" goto test_priority_select_2
