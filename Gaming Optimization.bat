...
:wait_outlast_2
tasklist|find "Outlast2.exe"
if %errorlevel% == 0 goto set_priority_outlast_2
timeout /t 1 >nul
goto wait_outlast_2

:wait_outlast_2_2
tasklist|find "Outlast2.exe"
if %errorlevel% == 0 goto set_priority_outlast_2_2
timeout /t 1 >nul
goto wait_outlast_2_2

:wait_phasmophobia_2
tasklist|find "Phasmophobia.exe"
...
Switching to the Ultimate Performance Powerplan...
