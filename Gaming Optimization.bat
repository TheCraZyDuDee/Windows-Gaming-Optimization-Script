...
if "%c%"=="16" goto cemu_2
if "%c%" GTR "16" goto game_select_2
...
echo 13 = set_priority_cemu
echo 14 = set_priority_cemu_2
echo 15 = set_priority_splitgate
echo 16 = set_priority_splitgate_2
...
if "%c%"=="13" goto set_priority_cemu
if "%c%"=="14" goto set_priority_cemu_2
if "%c%"=="15" goto set_priority_splitgate
if "%c%"=="16" goto set_priority_splitgate_2
...
echo.
echo 0 = Back
echo 1 = Enable Monitor 1
echo 2 = Enable Monitor 2
echo 3 = Disable Monitor 1
echo 4 = Disable Monitor 2
echo 5 = Set Monitor 1 as Primary
echo 6 = Set Monitor 2 as Primary
echo.
goto multi_select
...
if "%c%"=="1" goto enable_monitor_1
if "%c%"=="2" goto enable_monitor_2
if "%c%"=="3" goto disable_monitor_1
if "%c%"=="4" goto disable_monitor_2
if "%c%"=="5" goto primary_1
if "%c%"=="6" goto primary_2
if "%c%" GTR "6" goto app_select

:enable_monitor_1
echo.
echo Enable Monitor 1...
cd "%~dp0\Tools\MultiMonitorTool"
...
:enable_monitor_2
echo.
echo Enable Monitor 2...
cd "%~dp0\Tools\MultiMonitorTool"
MultiMonitorTool.exe /enable \\.\DISPLAY2
MultiMonitorTool.exe /TurnOn \\.\DISPLAY2
cls
echo.
echo Monitor sucessfully Enabled!
goto select_3
...
:primary_1
echo.
echo Set Monitor 1 Primary...
MultiMonitorTool.exe /SetPrimary \\.\DISPLAY1
cls
echo.
echo Primary Monitor sucessfully set!
goto select_3

:primary_2
echo.
echo Set Monitor 2 Primary...
