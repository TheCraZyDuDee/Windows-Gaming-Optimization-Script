...
echo 16 = Splitgate
echo 17 = Fable Anniversary
echo 18 = Cemu Emulator
echo.
goto game_select
...
echo 15 = Splitgate
echo 16 = Fable Anniversary
echo 17 = Cemu Emulator
echo.
goto game_select_2
...
if "%c%"=="16" goto splitgate
if "%c%"=="17" goto fable
if "%c%"=="18" goto cemu
if "%c%" GTR "18" goto game_select
...
if "%c%"=="15" goto splitgate_2
if "%c%"=="16" goto fable_2
if "%c%"=="17" goto cemu_2
if "%c%" GTR "17" goto game_select_2
...
if "%c%"=="4" goto browser_chrome
if "%c%"=="5" goto steam
if "%c%"=="6" goto epic
if "%c%" GTR "6" goto app_select
...
cls
echo.
echo Starting Fable Anniversary...
start "" "D:\Games\Fable Anniversary\Binaries\Win32\Fable Anniversary.exe"
echo Fable Anniversary started Sucessfully!
echo.
echo Waiting for Process...
echo.
goto wait_fable
...
:wait_fable
tasklist|find "Fable Anniversary.exe" >nul
if %errorlevel% == 0 goto set_priority_fable
timeout /t 1 >nul
goto wait_fable
...
:wait_fable_2
tasklist|find "Fable Anniversary.exe" >nul
if %errorlevel% == 0 goto set_priority_fable_2
timeout /t 1 >nul
goto wait_fable_2
...
echo 6 = Low
echo.
goto priority_select_fable

:set_priority_fable_2
cls
echo.
echo What Priority you want the Game to run at?
echo.
...
:priority_select_fable
set /p c=Select your Option: 
if "%c%"=="6969" goto why...
if "%c%"=="test" goto test_menu
if "%c%"=="1" goto fable_p_rt
if "%c%"=="2" goto fable_p_high
if "%c%"=="3" goto fable_p_anormal
if "%c%"=="4" goto fable_p_normal
if "%c%"=="5" goto fable_p_bnormal
if "%c%"=="6" goto fable_p_low
if "%c%" GTR "6" goto priority_select_fable
if "%c%" LSS "1" goto priority_select_fable

:priority_select_fable_2
set /p c=Select your Option: 
if "%c%"=="6969" goto why...
if "%c%"=="test" goto test_menu
if "%c%"=="1" goto fable_p_rt_2
if "%c%"=="2" goto fable_p_high_2
if "%c%"=="3" goto fable_p_anormal_2
if "%c%"=="4" goto fable_p_normal_2
if "%c%"=="5" goto fable_p_bnormal_2
if "%c%"=="6" goto fable_p_low_2
if "%c%" GTR "6" goto priority_select_fable_2
if "%c%" LSS "1" goto priority_select_fable_2
...
rem -----------------------Fable Anniversary-----------------------------

:fable_p_rt
wmic process where name="Fable Anniversary.exe" CALL setpriority "256" >nul
goto priority_done

:fable_p_high
wmic process where name="Fable Anniversary.exe" CALL setpriority "128" >nul
goto priority_done

:fable_p_anormal
wmic process where name="Fable Anniversary.exe" CALL setpriority "32768" >nul
goto priority_done

:fable_p_normal
wmic process where name="Fable Anniversary.exe" CALL setpriority "32" >nul
goto priority_done

:fable_p_bnormal
wmic process where name="Fable Anniversary.exe" CALL setpriority "16384" >nul
goto priority_done

:fable_p_low
wmic process where name="Fable Anniversary.exe" CALL setpriority "64" >nul
goto priority_done
...
start "" "C:\Program Files (x86)\MSI Afterburner\MSIAfterburner.exe" -Profile3
@ping -n 5 localhost> nul
taskkill /F /IM "MSIAfterburner.exe"
echo.
echo Done!
...
echo 5  = set_priority_b4b
echo 6  = set_priority_b4b_2
echo 7  = set_priority_dbd
echo 8  = set_priority_dbd_2
echo 9  = set_priority_pd2
echo 10 = set_priority_pd2_2
echo 11 = set_priority_waw
echo 12 = set_priority_waw_2
echo 13 = set_priority_bo3
echo 14 = set_priority_bo3_2
echo 15 = set_priority_plutonium
echo 16 = set_priority_plutonium_2
echo.
...
echo 3  = set_priority_gta5
echo 4  = set_priority_gta5_2
echo 5  = set_priority_pcbs
echo 6  = set_priority_pcbs_2
echo 7  = set_priority_raft
echo 8  = set_priority_raft_2
echo 9  = set_priority_genshinimpact
echo 10 = set_priority_genshinimpact_2
echo 11 = set_priority_killingfloor2
echo 12 = set_priority_killingfloor2_2
echo 13 = set_priority_fable
echo 14 = set_priority_fable_2
echo 15 = set_priority_cemu
echo 16 = set_priority_cemu_2
echo 17 = set_priority_splitgate
echo 18 = set_priority_splitgate_2
...
if "%c%"=="5" goto set_priority_b4b
if "%c%"=="6" goto set_priority_b4b_2
if "%c%"=="7" goto set_priority_dbd
if "%c%"=="8" goto set_priority_dbd_2
if "%c%"=="9" goto set_priority_pd2
if "%c%"=="10" goto set_priority_pd2_2
if "%c%"=="11" goto set_priority_waw
if "%c%"=="12" goto set_priority_waw_2
if "%c%"=="13" goto set_priority_bo3
if "%c%"=="14" goto set_priority_bo3_2
if "%c%"=="15" goto set_priority_plutonium
if "%c%"=="16" goto set_priority_plutonium_2
if "%c%" GTR "16" goto test_priority_select
...
if "%c%"=="3" goto set_priority_gta5
if "%c%"=="4" goto set_priority_gta5_2
if "%c%"=="5" goto set_priority_pcbs
if "%c%"=="6" goto set_priority_pcbs_2
if "%c%"=="7" goto set_priority_raft
if "%c%"=="8" goto set_priority_raft_2
if "%c%"=="9" goto set_priority_genshinimpact
if "%c%"=="10" goto set_priority_genshinimpact_2
if "%c%"=="11" goto set_priority_killingfloor2
if "%c%"=="12" goto set_priority_killingfloor2_2
if "%c%"=="13" goto set_priority_fable
if "%c%"=="14" goto set_priority_fable_2
if "%c%"=="15" goto set_priority_cemu
if "%c%"=="16" goto set_priority_cemu_2
if "%c%"=="17" goto set_priority_splitgate
if "%c%"=="18" goto set_priority_splitgate_2
if "%c%" GTR "16" goto test_priority_select_2
