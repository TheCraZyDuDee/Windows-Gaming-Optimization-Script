...
:winver
cls
if exist "%~dp0\Temp\win11" goto start
if exist "%~dp0\Temp\win10" goto start
echo First start, checking Windows Version...
echo Please be patient...
echo.
mkdir "%~dp0\Temp"
systeminfo|find "Microsoft Windows 11" >nul
if %errorlevel% == 0 echo.>"%~dp0\Temp\win11"
if %errorlevel% == 1 echo.>"%~dp0\Temp\win10"
else echo.>"%~dp0\Temp\unknown"
goto start
...
if exist "%~dp0\Temp\win11" echo Current Windows Version: 11 (Partly Supported)
if exist "%~dp0\Temp\win10" echo Current Windows Version: 10 (Supported)
if exist "%~dp0\Temp\unknown" echo Current Windows Version: Unknown (Not Supported)
echo.
...
:dwm_check
if exist "%~dp0\Temp\win11" cls & echo. & echo Windows 11 is not Supported! & goto select_3
